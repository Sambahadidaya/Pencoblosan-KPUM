...
// ====================
// UPDATE COUNTDOWN UNTUK HALAMAN LOGIN
// ====================
function updateCountdown() {
  ...
  if (now < startTime) {
    ...
    // Sudah melewati penutupan, sembunyikan countdown
...
// ====================
const startTime = new Date('2025-12-01T08:00:00+07:00'); // Waktu mulai: 1 Desember 2025, 08:00 WIB
const endTime = new Date('2025-12-01T15:30:00+07:00');   // Waktu selesai: 1 Desember 2025, 09:00 WIB

// Fungsi untuk cek apakah voting sedang terbuka
function isVotingOpen() {
  const now = new Date();
  return now >= startTime && now <= endTime;
}

// Fungsi untuk menghitung waktu tunggu hingga mulai (format: jam-menit)
